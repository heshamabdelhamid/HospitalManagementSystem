            ...
            <div class="card custom-card" id="vertical">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Below is an example of a basic navigation in a vertical mode
                        </p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="nav5">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="p-3 bg-light mb-3">
	<nav class="nav main-nav flex-column flex-md-row justify-content-center">
		<a class="nav-link active" href="#">Home</a>
		<a class="nav-link" href="#">About</a>
		<a class="nav-link" href="#">Pages</a>
            ...
            <div class="card custom-card" id="underline">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Below is a type of navigation that have a line at the bottom
                            of active link.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="nav8">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="tab-content">
	<div class="tab-pane active show" id="tabCont1">
