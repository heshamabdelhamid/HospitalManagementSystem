            ...
            <div class="card custom-card" id="aligning">
                <div class="card-body ht-100p">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="clearfix">
                                <img src="{{ URL::asset('dashboard/img/photos/10.jpg') }}"
                                    class="float-sm-left wd-100p wd-sm-200" alt="img">
                                <img src="{{ URL::asset('dashboard/img/photos/11.jpg') }}"
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('dashboard/img/photos/4.jpg') }}" alt="thumb1"
                                ...
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('dashboard/img/photos/9.jpg') }}" alt="thumb1"
                                                class="thumbimg  wd-100p">
                                        </a>
                                        <div class="caption">
                                            <h5>Thumbnail label</h5>
                                ...
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('dashboard/img/photos/8.jpg') }}" alt="thumb1"
                                                class="thumbimg  wd-100p">
                                        </a>
                                        <div class="caption">
                                            <h5>Thumbnail label</h5>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div><img alt="Responsive image" class="img-fluid"
                                    src="{{ URL::asset('dashboard/img/photos/7.jpg') }}"></div>
                        </div>
                        ...
                        <figure class="highlight clip-widget" id="images1">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('dashboard/img/media/7.jpg')}}"></div>
</script></code></pre>
