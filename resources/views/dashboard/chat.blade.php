...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Mail</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Chat</span>
            </div>
        </div>
                ...
                <div class="main-content-left main-content-left-chat">
                    <nav class="nav main-nav-line main-nav-line-chat">
                        <a class="nav-link active" data-toggle="tab" href="">Recent Chat</a> <a class="nav-link"
                            data-toggle="tab" href="">Groups</a> <a class="nav-link" data-toggle="tab"
                            href="">Calls</a>
                    </nav>
                        ...
                        <div class="main-chat-contacts" id="chatActiveContacts">
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/3.jpg') }}"></div><small>Adrian</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/12.jpg') }}"></div><small>John</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/4.jpg') }}"></div><small>Daniel</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/13.jpg') }}"></div><small>Katherine</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/5.jpg') }}"></div><small>Raymart</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/14.jpg') }}"></div><small>Junrisk</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/6.jpg') }}"></div><small>George</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/img/faces/15.jpg') }}"></div><small>Maryjane</small>
                            </div>
                            <div>
                    ...
                    <div class="main-chat-list" id="ChatList">
                        ...
                        <div class="media selected">
                            <div class="main-img-user online"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/9.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/11.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/4.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/8.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/12.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/15.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/10.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/3.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/7.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media border-bottom-0">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/img/faces/6.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                    ...
                    <div class="main-chat-header">
                        ...
                        <nav class="nav">
                            <a class="nav-link" href=""><i class="icon ion-md-more"></i></a> <a class="nav-link"
                                data-toggle="tooltip" href="" title="Call"><i
                                    class="icon ion-ios-call"></i></a> <a class="nav-link" data-toggle="tooltip"
                                href="" title="Archive"><i class="icon ion-ios-filing"></i></a> <a
                                class="nav-link" data-toggle="tooltip" href="" title="Trash"><i
                                    class="icon ion-md-trash"></i></a> <a class="nav-link" data-toggle="tooltip"
                            ...
                            <div class="media flex-row-reverse">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="main-msg-wrapper pd-0"><img alt="" class="wd-100 ht-100"
                                            src="{{ URL::asset('dashboard/img/ecommerce/01.jpg') }}"></div>
                                    <div>
                            ...
                            <div class="media flex-row-reverse">
                                ...
                                <div class="media-body">
                                    <div class="main-msg-wrapper right">
                                        ...
                                        massa quis enim. Donec pede justo, fringilla vel, aliquet nec. In enim justo,
                                        rhoncus ut, imperdiet a, venenatis vitae, justo.
                                    </div>
                                    <div class="main-msg-wrapper right">
                                        Nullam dictum felis eu pede mollis pretium
                ...
                <div class="main-chat-footer">
                    <nav class="nav">
                        <a class="nav-link" data-toggle="tooltip" href="" title="Add Photo"><i
                            ...
                            title="Attach a File"><i class="fas fa-paperclip"></i></a> <a class="nav-link"
                            data-toggle="tooltip" href="" title="Add Emoticons"><i class="far fa-smile"></i></a>
                        <a class="nav-link" href=""><i class="fas fa-ellipsis-v"></i></a>
                    </nav><input class="form-control" placeholder="Type your message here..." type="text"> <a
