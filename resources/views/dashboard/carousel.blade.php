                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/8.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/9.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/10.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="carousel slide" data-ride="carousel" id="carouselExample2">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/18.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/12.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/13.jpg') }}">
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="carousel slide" data-ride="carousel" id="carouselExample3">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/14.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/15.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/16.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="carousel-inner bg-dark">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100 op-3"
                                        src="{{ URL::asset('dashboard/img/photos/17.jpg') }}">
                                ...
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100 op-3"
                                        src="{{ URL::asset('dashboard/img/photos/19.jpg') }}">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Third Slide</h5>
                                        <p class="tx-14">Praesent commodo cursus magna, vel scelerisque nisl consectetur.
                                        </p>
                    ...
                    <div>
                        <div class="carousel slide carousel-fade" data-ride="carousel" id="carouselExample5">
                            ...
                            <div class="carousel-inner bg-dark">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/20.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/1.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('dashboard/img/photos/2.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active"><img
                                        src="{{ URL::asset('dashboard/img/photos/1.jpg') }}" alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/2.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/3.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/4.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/5.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/6.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/7.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('dashboard/img/photos/8.jpg') }}"
                                        alt="img"> </div>
                            </div>
                        ...
                        <div class="MS-content">
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/1.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/2.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/3.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/4.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/5.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/6.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/7.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/8.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/9.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/10.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('dashboard/img/photos/11.jpg') }}" alt="" /> </a>
                            </div>
                        </div>
                    </div>
                </div>
