                        ...
                        <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img alt="avatar" class="rounded-circle avatar-md mr-2"
                                            src="{{ URL::asset('dashboard/img/faces/1.jpg') }}">
                                    </td>
                                    <td>Megan Peters</td>
                                    <td>
                                        08/06/2020
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-danger d-flex">
                                            <div class="dot-label bg-danger ml-1"></div> Banned
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-warning d-flex">
                                            <div class="dot-label bg-warning ml-1"></div>Pending
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img alt="avatar" class="rounded-circle avatar-md mr-2"
                                            src="{{ URL::asset('dashboard/img/faces/17.jpg') }}">
                                    </td>
                                    <td>Paul Molive</td>
                                    <td>
                                        12/07/2020
