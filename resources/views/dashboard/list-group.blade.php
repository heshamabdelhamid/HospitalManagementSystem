                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="list01">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="listgroup-example ">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="list02">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="listgroup-example2">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
                        ...
                        <div class="example">
                            <div class="list-group">
                                <a class="list-group-item list-group-item-action flex-column align-items-start active"
                                    ...
                                    <span class="d-flex">
                                        <img alt="" class="ml-3 rounded-circle avatar-md"
                                            src="{{ URL::asset('dashboard/img/faces/3.jpg') }}">
                                        <div class="">
                                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <a class="list-group-item list-group-item-action flex-column align-items-start"
                                    ...
                                    <span class="d-flex">
                                        <img alt="" class="ml-3 rounded-circle avatar-md"
                                            src="{{ URL::asset('dashboard/img/faces/8.jpg') }}">
                                        <div class="">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h5 class="mb-2 tx-14">List group item heading</h5><small>3 days
                                                    ago</small>
                                ...
                                <a class="list-group-item list-group-item-action flex-column align-items-start"
                                    ...
                                    <span class="d-flex">
                                        <img alt="" class="ml-3 rounded-circle avatar-md"
                                            src="{{ URL::asset('dashboard/img/faces/11.jpg') }}">
                                        <div class="">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h5 class="mb-2 tx-14">List group item heading</h5><small>3 days
                                                    ago</small>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                            ...
                            <div class="list-group">
                                    ...
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('dashboard/img/faces/17.jpg') }}" alt="avatar">
                                        </div>
                                ...
                                <div class="list-group-item pd-y-20">
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('dashboard/img/faces/5.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="media-body d-flex">
                                ...
                                <div class="list-group-item pd-y-20">
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('dashboard/img/faces/12.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="media-body d-flex">
                        ...
                        <figure class="highlight clip-widget" id="list03">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="list-group">
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <ul class="list-group wd-md-100p users-list-group">
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    <img alt="" class="ml-3 rounded-circle avatar-md"
                                        src="{{ URL::asset('dashboard/img/faces/15.jpg') }}">
                                    <div>
                                        <h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span
                                            class="d-block tx-13 text-muted">Premium Member</span>
                                    </div>
                        ...
                        <figure class="highlight clip-widget" id="list08">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><ul class="list-group wd-md-100p users-list-group">
	<li class="list-group-item d-flex align-items-center">
