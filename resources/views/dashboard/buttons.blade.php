                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="element1">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-primary btn-block">Primary</button>
	</div>
	<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code22" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code22" data-toggle="tab"
                                    href="#html-code22" role="tab" aria-controls="html-code22"
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight clip-widget" id="element5">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="btn-icon-list">
	<button class="btn btn-indigo btn-icon"><i class="typcn typcn-folder"></i></button>
