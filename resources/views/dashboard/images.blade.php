...
@section('content')
    ...
    <div class="card mg-b-20" id="image1">
        <div class="card-body">
            ...
            <div class="text-wrap">
                <div class="example">
                    <div><img alt="Responsive image" class="img-fluid" src="{{ URL::asset('dashboard/img/photos/1.jpg') }}">
                    </div>
                </div>
            </div>
    ...
    <div class="card mg-b-20" id="image3">
        <div class="card-body">
            ...
            <figure class="highlight clip-widget mb-0" id="image-3">
                <pre><code class="language-markup"><script type="html-dashlead/script"><div class="bd pd-20 clearfix">
    ...
    <div class="card" id="image4">
        <div class="card-body">
            ...
            <figure class="highlight clip-widget mb-0" id="image-4">
                <pre><code class="language-markup"><script type="html-dashlead/script"><figure class="pos-relative mg-b-0 wd-sm-80p wd-md-50p">
