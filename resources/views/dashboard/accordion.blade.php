                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('dashboard/img/photos/8.jpg') }}" alt="banner image">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('dashboard/img/photos/10.jpg') }}" alt="banner image ">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('dashboard/img/photos/11.jpg') }}" alt="banner image ">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded "
                                                src="{{ URL::asset('dashboard/img/photos/12.jpg') }}" alt="banner image ">
                                        </div>
                                    </div>
                                </div>
                            </div>
