        ...
        <div class="col-sm-12 col-md-12 col-xl-4">
            <div class="card custom-card">
                <div class="card-body text-center">
                    ...
                    <img src="{{ URL::asset('dashboard/img/media/illustrate.png') }}" alt="counter-image"
                        class="wd-160 ht-160 ">
                    <div class="pb-0 mt-3">
        ...
        <div class="col-sm-12 col-md-12 col-xl-4">
            <div class="card custom-card">
                <div class="card-body text-center">
                    ...
                    <img src="{{ URL::asset('dashboard/img/media/illustrate1.png') }}" alt="counter-image"
                        class="wd-160 ht-160 ">
                    <div class="mt-3">
        ...
        <div class="col-sm-12 col-md-12 col-xl-4">
            <div class="card custom-card">
                <div class="card-body text-center ">
                    ...
                    <img src="{{ URL::asset('dashboard/img/media/illustrate2.png') }}" alt="counter-image"
                        class="wd-160 ht-160 ">
                    <div class="mt-3">
