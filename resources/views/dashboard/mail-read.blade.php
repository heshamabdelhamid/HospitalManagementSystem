                    ...
                    <div class="main-mail-menu">
                        <nav class="nav main-nav-column mg-b-20">
                            ...
                            <a class="nav-link" href=""><i class="bx bx-message-square-detail"></i> Chats
                                <span>14</span></a>
                            <a class="nav-link" href=""><i class="bx bx-folder-open"></i> All Mail
                                <span>652</span></a>
                ...
                <div class="card-body">
                    <div class="email-media">
                        <div class="mt-0 d-sm-flex">
                            <img class="ml-2 rounded-circle avatar-xl" src="{{ URL::asset('dashboard/img/faces/6.jpg') }}"
                                alt="avatar">
                            <div class="media-body">
                                <div class="float-left d-none d-md-flex fs-15">
                                    <span class="mr-3">Sep 13 , 2019 12:45 pm</span>
                                    <small class="mr-3"><i class="bx bx-star tx-18" data-toggle="tooltip"
                                            title="" data-original-title="Rated"></i></small>
                                    <small class="mr-3"><i class="bx bx-reply tx-18" data-toggle="tooltip"
                                ...
                                <div class="media-title  font-weight-bold mt-3">Alica Nestle <span class="text-muted">(
                                        alicnestle@gmail.com )</span></div>
                        ...
                        <div class="email-attch">
                            ...
                            <div class="emai-img">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="m-2">
                                        <a href="#"><img class="wd-150 mb-2"
                                                src="{{ URL::asset('dashboard/img/photos/3.jpg') }}"
                                                alt="placeholder image"></a>
