            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tx-center pd-y-20 bg-gray-200">
                        <a class="btn btn-main-primary" data-target="#modaldemo1" data-toggle="modal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <div class="d-flex pos-absolute t-5 r-10"><img alt=""
                                                class="wd-30 mg-r-5" src="{{ URL::asset('dashboard/img/visa.png') }}">
                                            <img alt="" class="wd-30"
                                                src="{{ URL::asset('dashboard/img/mastercard.png') }}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
