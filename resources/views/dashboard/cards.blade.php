...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Apps</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Cards</span>
            </div>
        </div>
...
@section('content')
        ...
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                <div class="card-body ">
                    ...
                    src="{{ URL::asset('dashboard/img/photos/11.jpg') }}">
            </div>
        </div><!-- col-4 -->
    </div>
    <!-- /row closed -->
    ...
    <div class="row row-sm">
        ...
        <div class="col-md mg mg-md-t-0">
            <div class="card">
                <img alt="Image" class="card-img img-fluid card-img-top"
                    src="{{ URL::asset('dashboard/img/photos/5.jpg') }}">
                <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
        ...
        <div class="col-md mg-md-t-0">
            <div class="card">
                <img alt="Image" class="card-img img-fluid card-img-top"
                    src="{{ URL::asset('dashboard/img/photos/6.jpg') }}">
                <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
